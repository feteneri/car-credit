...
var BeforePipe = /** @class */ (function () {
    ...
    BeforePipe.prototype.transform = function (value) {
        var args = [];
...
var CalculatorService = /** @class */ (function () {
    function CalculatorService(carPrice) {
        var _this = this;
        this.carPrice = 0;
        this.creditRate = 0;
        ...
        this.target = 0;
        /* change handlers */
        this.getBaseLog = function (x, y) { return Math.log(y) / Math.log(x); };
        this.onChangeFirstPaymentValue = function (value) {
            console.log('onChangeFirstPaymentValue');
            _this.firstPaymentValue = value;
            _this.updateMonthlyPayment();
            _this.updateWillPayRange();
            _this.updateTotalSumm();
            _this.altValueFirstPay = Math.round((value / _this.carPrice) * 100);
        };
        this.onChangeWillPayValue = function (value) {
            _this.willPayValue = Math.round(value);
            _this.termValue = ((Math.round(_this.getTermByMonthlyPayment() / 6) + 1) * 6) > _this.maxTerm ? _this.maxTerm : ((Math.round(_this.getTermByMonthlyPayment() / 6) + 1) * 6);
        };
        this.onChangeTermValue = function (value) {
            _this.termValue = value;
            _this.updateMonthlyPayment();
            _this.updateWillPayRange();
            _this.updateTotalSumm();
        };
        /* end: change handlers */
        /* calculations */
        this.updateTermValue = function () {
            _this.termValue = Math.round((_config__WEBPACK_IMPORTED_MODULE_2__["config"].maxTerm - _config__WEBPACK_IMPORTED_MODULE_2__["config"].minTerm) / 2 + _config__WEBPACK_IMPORTED_MODULE_2__["config"].minTerm);
        };
        this.getCreditSumm = function () { return _this.carPrice - _this.firstPaymentValue; };
        this.getMonthlyPercent = function () { return 1 + _config__WEBPACK_IMPORTED_MODULE_2__["config"].creditRate / MONTHS_IN_YEAR / 100; };
        this.getMonthlyPayment = function (monthCount) {
            var summ = _this.getCreditSumm();
            var percent = _this.getMonthlyPercent();
            return Math.pow(percent, monthCount) * ((percent - 1) / (Math.pow(percent, monthCount) - 1)) * summ;
        };
        this.updateMonthlyPayment = function () {
            _this.monthlyPayment = _this.getMonthlyPayment(_this.termValue);
        };
        this.getWillPayRange = function () {
            var minWillPay = _this.getMonthlyPayment(_config__WEBPACK_IMPORTED_MODULE_2__["config"].maxTerm);
            var maxWillPay = _this.getMonthlyPayment(_config__WEBPACK_IMPORTED_MODULE_2__["config"].minTerm);
            var willPayValue = Math.round(((maxWillPay - minWillPay) / 2) + minWillPay);
            return { minWillPay: minWillPay, maxWillPay: maxWillPay, willPayValue: willPayValue };
        };
        this.updateWillPayRange = function () {
            var _a = _this.getWillPayRange(), minWillPay = _a.minWillPay, maxWillPay = _a.maxWillPay, willPayValue = _a.willPayValue;
            _this.minWillPay = minWillPay;
            _this.maxWillPay = maxWillPay;
            _this.willPayValue = Math.round(willPayValue);
        };
        this.getTotalSumm = function () { return _this.monthlyPayment * _this.termValue; };
        this.updateTotalSumm = function () {
            _this.totalSumm = _this.getTotalSumm();
        };
        this.getTermByMonthlyPayment = function () {
            var summ = _this.getCreditSumm();
            var percent = _this.getMonthlyPercent();
            return Math.round(getBaseLog(1.01, 1 + 0.01 / (_this.willPayValue / summ - 0.01)));
        };
...
var CarCreditCalcComponent = /** @class */ (function () {
    function CarCreditCalcComponent() {
    }
    CarCreditCalcComponent.prototype.ngOnInit = function () {
...
var CarCreditComponent = /** @class */ (function () {
    function CarCreditComponent(route) {
        var _this = this;
        ...
        route.params.subscribe(function (params) {
            var carId = params['id'];
            _this.car = _assets_cars__WEBPACK_IMPORTED_MODULE_3__["carsList"].find(function (car) { return car.id === carId; });
        });
    }
    CarCreditComponent.prototype.ngOnInit = function () { };
    CarCreditComponent.ctorParameters = function () { return [
...
var CreditRangeComponent = /** @class */ (function () {
    function CreditRangeComponent() {
    }
    CreditRangeComponent.prototype.ngOnInit = function () { };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
var FromPipe = /** @class */ (function () {
    function FromPipe() {
    }
    FromPipe.prototype.transform = function (value) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
...
var LabeledValueComponent = /** @class */ (function () {
    function LabeledValueComponent() {
    }
    //constructor() { }
    LabeledValueComponent.prototype.ngOnInit = function () {
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
...
var pluralize = function (val, options) {
    var parsedVal = parseInt(val.toString().replace(/ /g, ''), 10);
    var modulo = parsedVal % 10;
    var text = options.other;
...
var PeriodPipe = /** @class */ (function () {
    ...
    PeriodPipe.prototype.transform = function (months) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
        var monthsInYear = 12;
        var fullYears = Math.floor(months / monthsInYear);
        var yearsText = fullYears + " " + pluralize(fullYears, { 1: 'год', 2: 'года', other: 'лет' });
        var monthsReminds = months % monthsInYear;
        var monthsText = monthsReminds + " " + pluralize(monthsReminds, {
            1: 'месяц',
            2: 'месяца',
            other: 'месяцев',
        });
...
var RublesPipe = /** @class */ (function () {
    function RublesPipe() {
    }
    RublesPipe.prototype.transform = function (value) {
        var args = [];
        for (var _i = 1; _i < arguments.length; _i++) {
            args[_i - 1] = arguments[_i];
        }
        return Math.round(value)
            ...
            .split('')
            .reverse()
            .reduce(function (prevChars, currentChar, charIndex) {
            return charIndex !== 0 && charIndex % 3 === 0
                ? tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](prevChars, [' ', currentChar]) : tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](prevChars, [currentChar]);
        }, [])
            .reverse()
            .join('') + " \u20BD";
    };
